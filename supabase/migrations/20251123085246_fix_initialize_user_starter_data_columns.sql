/*
  # Fix initialize_user_starter_data function - Correct column names

  1. Changes
    - Utiliser default_unit au lieu de unit pour catalog_items
    - Ajouter les colonnes manquantes pour catalog_items
    - Corriger le type de stock_quantity pour resources (numeric au lieu de integer)

  2. Notes
    - catalog_items utilise default_unit, pas unit
    - resources utilise stock_quantity de type numeric
*/
