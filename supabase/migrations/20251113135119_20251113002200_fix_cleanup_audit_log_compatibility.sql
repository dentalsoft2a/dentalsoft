/*
  # Correction de la compatibilité avec audit_log
  
  Cette migration corrige la fonction de nettoyage pour être compatible
  avec la structure réelle de la table audit_log.
*/

-- Corriger la fonction pour être compatible avec audit_log
...
BEGIN
  ...
  -- Log dans audit_log si la table existe (avec la structure correcte)
