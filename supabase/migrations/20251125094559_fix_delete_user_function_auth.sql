/*
  # Fix delete user function authentication

  1. Changes
    - Modifie la fonction pour accepter l'ID du super admin comme paramètre
    - Retire la vérification auth.uid() qui ne fonctionne pas avec service role
*/
