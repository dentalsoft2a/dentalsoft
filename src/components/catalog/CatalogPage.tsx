      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredItems.map((item) => (
            <div
              key={item.id}
              className="bg-white rounded-xl shadow-md border border-slate-200 hover:shadow-lg hover:border-primary-300 transition-all duration-300 overflow-hidden group"
            >
              <div className="p-4">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1.5">
                      <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-cyan-500 rounded-lg flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform duration-300">
                        <Package className="w-5 h-5" />
                      </div>
                      <div className="flex-1">
                        <h3 className="font-bold text-base text-slate-900 group-hover:text-primary-700 transition-colors line-clamp-1">
                          {item.name}
                        </h3>
                        {item.is_active ? (
                ...
                <div className="space-y-2 mb-3">
                  {item.category && (
                    <div className="flex items-center gap-2 text-xs text-slate-600 group/item hover:text-primary-600 transition-colors">
                      <div className="w-7 h-7 bg-slate-100 rounded-lg flex items-center justify-center group-hover/item:bg-primary-50 transition-colors">
                ...
                <div className="pt-3 border-t border-slate-100 space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-[10px] text-slate-500">Prix par défaut</p>
                      <p className="text-lg font-bold text-slate-900">{Number(item.default_price).toFixed(2)} €</p>
                    </div>
                  </div>
                ...
                <div className="flex items-center gap-1.5 mt-3 pt-3 border-t border-slate-100">
                  <button
                    onClick={() => handleOpenModal(item)}
                    className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-primary-600 bg-primary-50 hover:bg-primary-100 rounded-lg transition-all duration-200 font-medium text-sm"
                  >
                  ...
                  <button
                    ...
                    className="p-2 text-slate-600 hover:bg-slate-100 rounded-lg transition-all duration-200"
