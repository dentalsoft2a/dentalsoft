...
export default function DashboardLayout({ children, currentPage, onNavigate, isSuperAdmin, lowStockCount = 0, lowStockResourcesCount = 0, hasValidSubscription = true }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="lg:hidden fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md border-b border-slate-200 z-[100] px-4 py-4 shadow-md h-[72px]">
      ...
      <main className="lg:pl-64 flex-1 flex flex-col mt-[72px] lg:mt-0">
