          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-black/60 backdrop-blur-md rounded-2xl p-4 border-2 border-white/20">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-white font-semibold text-sm">Photos capturées</h3>
                <button
              ...
              <div className="grid grid-cols-3 gap-3">
                {capturedPhotos.map((photo, index) => (
                  <div key={photo.id} className="relative group">
                    <div className="aspect-square rounded-lg overflow-hidden border-2 border-white/40 shadow-lg">
                      <img
                        src={photo.imageData}
                        alt={`Photo ${index + 1}`}
                    ...
                    <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm rounded-full w-6 h-6 flex items-center justify-center text-xs font-bold text-slate-900">
                      {index + 1}
                    </div>
                    <button
