...
export default function ThreeShapeSyncDashboard() {
  const { user } = useAuth();
  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h2 className="text-xl md:text-2xl font-bold text-slate-900">Synchronisations 3Shape Communicate</h2>
      ...
      {syncLogs.length === 0 ? (
        <div className="text-center py-12 bg-white rounded-2xl border border-slate-200">
          ...
          <p className="text-slate-600">Les synchronisations 3Shape Communicate apparaîtront ici</p>
        </div>
      ) : (
