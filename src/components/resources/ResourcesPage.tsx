        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          ...
          <div className="flex gap-2 md:gap-3 overflow-x-auto">
            ...
            <button
              ...
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-5 py-2.5 md:py-3 bg-white border-2 border-slate-300 text-slate-700 rounded-lg md:rounded-xl hover:bg-slate-50 hover:border-slate-400 transition-all duration-200 hover:scale-105 active:scale-95 text-sm md:text-base font-medium whitespace-nowrap"
            >
            ...
            <button
              ...
              className="hidden md:flex items-center justify-center gap-2 px-4 md:px-5 py-2.5 md:py-3 bg-white border-2 border-primary-300 text-primary-700 rounded-lg md:rounded-xl hover:bg-primary-50 hover:border-primary-400 transition-all duration-200 hover:scale-105 active:scale-95 text-sm md:text-base font-medium"
            ...
            >
              <RefreshCw className={`w-5 h-5 flex-shrink-0 ${refreshing ? 'animate-spin' : ''}`} />
              <span>Actualiser</span>
            </button>
            <button
              onClick={() => handleOpenModal()}
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 md:px-5 py-2.5 md:py-3 bg-gradient-to-r from-primary-600 to-cyan-600 text-white shadow-lg hover:shadow-xl rounded-lg md:rounded-xl hover:from-primary-700 hover:to-cyan-700 transition-all duration-200 hover:scale-105 active:scale-95 text-sm md:text-base font-medium whitespace-nowrap"
            >
