...
export default function MonthOnlyPicker({ value, onChange, label, required = false, color = 'primary' }: MonthOnlyPickerProps) {
  ...
  const formatDisplayMonth = (monthNumber: number) => {
    const monthNames = [
  ...
  return (
    <div className="relative" ref={pickerRef}>
      ...
      <div className="relative">
        ...
        >
          {value ? formatDisplayMonth(value) : 'Sélectionner un mois'}
        </button>
